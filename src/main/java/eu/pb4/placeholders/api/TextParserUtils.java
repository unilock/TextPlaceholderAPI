...
public final class TextParserUtils {
    ...
    public static ITextComponent formatText(String text) {
        return formatNodes(text).toText(null, true);
    }

    public static ITextComponent formatTextSafe(String text) {
        return formatNodesSafe(text).toText(null, true);
    }

    public static ITextComponent formatText(String text, TextParserV1.TagParserGetter getter) {
